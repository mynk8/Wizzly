...
const Speak = () => {
  ...
  return (
    <div className="flex flex-col flex-1 justify-end items-center overflow-y-hidden max-h-52">
      ...
      <div className="flex flex-row flex-1 justify-center mt-4">
        <button
          ref={connectButtonRef as any}
          className="bg-blue-500 text-white px-4 py-2 focus:ring-0 hover:bg-blue-600 outline-none shadow-xs transition"
        ...
        <button
          ...
          className="bg-red-400 text-white px-4 py-2 hover:bg-red-600 transition"
        >
