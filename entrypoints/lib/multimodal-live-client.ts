...
export interface LiveClientEventTypes {
  ...
  outputtranscription: (transcription: { text: string; finished: boolean }) => void;
}
  ...
  protected async onmessage(message: LiveServerMessage) {
    ...
    if (message.serverContent) {
      ...
      if (serverContent.outputTranscription) {
        this.log("server.outputTranscription", `text: "${serverContent.outputTranscription.text}", finished: ${serverContent.outputTranscription.finished}`);
